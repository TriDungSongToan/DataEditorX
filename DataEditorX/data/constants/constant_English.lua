...
--========== Activity Code ==========--
ACTIVITY_SUMMON		=1	--Refers to the action of attempting to perform Summons of any kind
ACTIVITY_NORMALSUMMON	=2	--Refers to the action of performing a Normal Summon
ACTIVITY_SPSUMMON	=3	--Refers to the action of performing Special Summons
ACTIVITY_FLIPSUMMON	=4	--Refers to the action of performing Flip Summons
ACTIVITY_ATTACK		=5	--The action of declaring attacks.
ACTIVITY_BATTLE_PHASE	=6	--Refers to the act of conducting a battle phase. This activity is not available with custom counter
ACTIVITY_CHAIN		=7	--An activity only available with custom counter
--========== Announcement Type ==========--
ANNOUNCE_CARD		=7	--Card declaration
ANNOUNCE_CARD_FILTER	=8	--Card declaration with filters
--========== Assume Code ==========--
...
EFFECT_IMMUNE_EFFECT		=1	--Affected card is unaffected by card effects. The SetValue of this effect takes the following parameters:
EFFECT_CLIENT_MODE_RESET	=2	--Internally called by the core
EFFECT_DISABLE			=2	--Ineffective (skills extraction)
...
EFFECT_FORCE_MZONE		=265	--Forces a zone to be used (see Dai Dance).
